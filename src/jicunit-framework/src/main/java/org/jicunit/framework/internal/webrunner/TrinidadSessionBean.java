...
@Named("tSessionBean")
@SessionScoped
public class TrinidadSessionBean implements RunnerCallback, Serializable {
  ...
  public TrinidadSessionBean() {
  }

  // only for unit test
  protected TrinidadSessionBean(ApplicationBean applicationBean, RunnerBean runnerBean) {
  ...
  protected void run(List<TestDescription> selectedTests) {
    ...
    mRunnerBean.runAsync(this, selectedTests);
  }
